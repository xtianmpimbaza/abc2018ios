...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__speakers__ = __webpack_require__(354);
...
SpeakersPage = __decorate([
    ...
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["K" /* Component */])({
        selector: 'page-speakers',template:/*ion-inline-start:"F:\abconference\src\pages\speakers\speakers.html"*/'<ion-header>\n\n  <ion-navbar>\n    <ion-title>speakers</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content>\n\n  <ion-list>\n\n    <button ion-item *ngFor="let speaker of speakers" (click)="openSpeakerDetail(speaker)">\n      <ion-avatar item-left>\n        <img src="{{speaker.picture}}"/>\n      </ion-avatar>\n      <h2>{{speaker.name}}</h2>\n      <p>{{speaker.title}}</p>\n    </button>\n\n  </ion-list>\n\n</ion-content>\n'/*ion-inline-end:"F:\abconference\src\pages\speakers\speakers.html"*/,
    }),
